...
class _LoginScreenState extends State<LoginScreen> {
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      adminLogin(); // Call the adminLogin method when the button is pressed
                    },
                    child: Container(
                      width: double.infinity,
  ...
  void adminLogin() async {
    ...
    if (_emailController.text == 'mstacezro@gmail.com' &&
        _passwordController.text == 'masterpassword') {
      _ui.loadState(true);
      try {
        // Perform the admin login logic here
        // You can add your own implementation or navigate to the admin dashboard directly
      ...
      // The entered credentials are not for the admin
